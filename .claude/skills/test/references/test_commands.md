...
| Backend API tests | `python3 .claude/skills/test/scripts/test_backend.py` | project root | Backend on :8000 |
| Integration check | `python3 .claude/skills/test/scripts/check_integration.py --project-root .` | project root | No |
...
With custom URL:
```bash
python3 .claude/skills/test/scripts/test_backend.py --url http://localhost:8000
```
